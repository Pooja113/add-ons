...
class Subs_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'subs_widget', // Base ID
			esc_html__( 'Subscribers', 'subs_domain' ), // Name
			array( 'description' => esc_html__( 'Widget to dsplay subscribers', 'subs_domain' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Subscribers', 'subs_domain' );
    $channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'Google Developers', 'subs_domain' );
    $layout = ! empty( $instance['layout'] ) ? $instance['layout'] : esc_html__( 'Layout', 'subs_domain' );

    $count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( 'Count', 'subs_domain' );
		?>
		<p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_attr_e( 'Title:', 'subs_domain' ); ?></label> 
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
		</p>

    <p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'channel' ) ); ?>"><?php esc_attr_e( 'Channel Name:', 'subs_domain' ); ?></label> 
    ...
    <p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'layout' ) ); ?>"><?php esc_attr_e( 'Layout:', 'subs_domain' ); ?></label> 
    ...
    <p>
		<label for="<?php echo esc_attr( $this->get_field_id( 'count' ) ); ?>"><?php esc_attr_e( 'Subscribers Count:', 'subs_domain' ); ?></label> 
